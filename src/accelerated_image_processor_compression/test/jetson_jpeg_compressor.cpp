...
{
TEST_F(TestJPEGCompressor, JetsonCompressionDefault)
{
  JetsonJPEGCompressor compressor;
...
#else
TEST(JetsonJPEGCompressorSkip, JetsonUnavailable)
{
  GTEST_SKIP() << "Jetson not available. Skipping JetsonJPEGCompressor tests.";
}
#endif
