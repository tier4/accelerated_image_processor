...
# (2.6) where they added pkg_check_modules. Consequently I need to support both
# in my scripts to avoid those deprecated warnings. Here's a helper that does
# just that. Works identically to pkg_check_modules, except that no checks are
# needed prior to use.
...
# Do the final processing once the paths have been detected. If include dirs are
# needed, ${PREFIX}_PROCESS_INCLUDES should be set to contain all the variables,
# each of which contain one include directory. Ditto for ${PREFIX}_PROCESS_LIBS
# and library files. Will set ${PREFIX}_FOUND, ${PREFIX}_INCLUDE_DIRS and
