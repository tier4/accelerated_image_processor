...
# * Try to find nvjpeg
#
# The following variables are optionally searched for defaults NVJPEG_ROOT_DIR:
# Base directory where all NVJPEG components are found
#
# The following are set after configuration is done: NVJPEG_FOUND
# NVJPEG_INCLUDE_DIR NVJPEG_LIBRARY

set(NVJPEG_ROOT_DIR
    ""
    CACHE PATH "Folder contains NVJPEG")

find_path(
  NVJPEG_INCLUDE_DIR nvjpeg.h
  PATHS ${NVJPEG_ROOT_DIR} ${CMAKE_CUDA_TOOLKIT_INCLUDE_DIRECTORIES}
  PATH_SUFFIXES include)

find_library(
  NVJPEG_LIBRARY libnvjpeg_static.a nvjpeg
...
if(NVJPEG_FOUND)
  ...
  check_cxx_symbol_exists("nvjpegBufferPinnedCreate" "nvjpeg.h"
                          NVJPEG_DECOUPLED_API)
  check_cxx_symbol_exists("nvjpegDecodeBatchedPreAllocate" "nvjpeg.h"
                          NVJPEG_PREALLOCATE_API)
  ...
  if(NVJPEG_DECOUPLED_API)
    ...
    message(
      FATAL_ERROR
        "nvjpegBufferPinnedCreate is required but not present in the available version of nvJPEG"
    )
  endif()
