# * Try to find libjpeg-turbo Once done, this will define
#
# LibJpegTurbo_FOUND - system has libjpeg-turbo LibJpegTurbo_INCLUDE_DIRS - the
# libjpeg-turbo include directories LibJpegTurbo_LIBRARIES - link these to use
# libjpeg-turbo
#
...
# Include dir
find_path(
  LibJpegTurbo_INCLUDE_DIR
  NAMES turbojpeg.h
  HINTS ${LibJpegTurbo_PKGCONF_INCLUDE_DIRS} /opt/libjpeg-turbo/include
        /usr/include/)
...
find_library(
  ...
  NAMES turbojpeg
  HINTS ${LibJpegTurbo_PKGCONF_LIBRARY_DIRS} /opt/libjpeg-turbo/lib
        /usr/include/)
