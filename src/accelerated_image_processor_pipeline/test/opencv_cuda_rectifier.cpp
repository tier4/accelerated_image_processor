...
{
TEST_F(TestRectifier, OpenCvCudaRectificationDefault)
{
...
#else
TEST(OpenCvCudaRectifierSkip, OpenCvCudaUnavailable)
{
  GTEST_SKIP() << "OpenCV CUDA not available. Skipping OpenCvCudaRectifier tests.";
}
#endif
